...
export default function HomePage() {
  return (
    <main className="hp4 relative min-h-screen">
      <WeatherParticles />
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8 lg:py-12">
        ...
        <header className="mb-10 flex items-center justify-between">
          ...
          <span className="hidden items-center gap-2 rounded-full border border-glass-border bg-white/70 px-4 py-2 text-xs font-medium text-muted-foreground backdrop-blur-md sm:inline-flex">
